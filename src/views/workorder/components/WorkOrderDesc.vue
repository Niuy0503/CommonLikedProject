<template>
  ...
  >
    ...
    <el-descriptions v-if="currentRow.taskId" :column="2">
      ...
      <el-descriptions-item v-if="currentRow.taskStatusTypeEntity.statusId === 4" label="定位"> <i class="el-icon-location-outline" /> {{ currentRow.addr }}</el-descriptions-item>
    </el-descriptions>
    <!--? footer区域 -->
    ...
    <AddWorkOrder
      ...
      :product-type="currentRow.productTypeId"
