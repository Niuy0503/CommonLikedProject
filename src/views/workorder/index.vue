<template>
  <el-container>
    ...
    <!-- 分页器 -->
    <!-- 工单详情弹出层 -->
    <WorkOrderDesc v-if="WorkOrderDescVisible" :work-order-desc-visible.sync="WorkOrderDescVisible" :current-row="currentRow" @taskSearch="taskSearch" />
    <!-- 新增工单弹出层 -->
...
export default {
  components: { Table, WorkOrderDesc, AddWorkOrder },
  data() {
    return {
      loading: false,
      tableData: [],
