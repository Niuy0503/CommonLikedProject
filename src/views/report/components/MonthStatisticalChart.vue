<template>
  <el-container class="home-user-task-stats bg2 box">
    <el-header height="18px">月销售统计 </el-header>
    <el-main>
      <div class="stats">
        <div class="item">
          <div class="num color3 text-shadow2">{{ orderCount }}</div>
          <div class="text color3">当月销售量（个）</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          <div class="num color3 text-shadow2">{{ orderAmount }}</div>
          <div class="text color3">当月销售额（元）</div>
        </div>
      </div>
      <div class="stats">
        <div class="item">
          <div class="num color3 text-shadow2">{{ totalBill }}</div>
          <div class="text color3">当月分成（元）</div>
        </div>
      </div>
    </el-main>
  </el-container>
